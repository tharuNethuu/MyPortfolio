...
<motion.div className='textContainer' variants={variants}>
    ...
    <motion.div className='item' variants={variants}>
        <h2>Mail</h2>
        <span>tharu0nethu@gmail.com</span>
    </motion.div>
    <motion.div className='item' variants={variants}>
        <h2>Address</h2>
        <span>No68, Delgolla Watta B, Mawathagama</span>
    </motion.div>
    <motion.div className='item'variants={variants}>
        <h2>Phone</h2>
        <span>+94766020225</span>
    </motion.div>
</motion.div>
...
<svg height="350px" width="350px" fill='transparent' 
...
<g>
    ...
    <textarea placeholder="Message" required rows={8} name="message"></textarea>
